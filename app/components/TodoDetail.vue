...
<template>
  <div v-if="todoStore.activeTodo" class="h-full flex flex-col">
    <div class="flex items-center min-h-9 px-3 py-2">
      <UCheckbox
        v-model="checked"
        color="secondary"
        class="mr-2 pl-5"
    ...
    />
    <div id="todo-content-wrap" class="flex-1 overflow-y-auto [scrollbar-gutter:stable] pb-6" @click="handleContentClick">
